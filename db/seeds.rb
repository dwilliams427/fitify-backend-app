...
# abs = Workout.create(user_id: 1, name: "abs")

# we1_1 = WorkoutExercise.create(workout_id: 1, exercise_id: 5, user_id: 1)
# we1_2 = WorkoutExercise.create(workout_id: 1, exercise_id: 1, user_id: 1)
# we1_3 = WorkoutExercise.create(workout_id: 1, exercise_id: 4, user_id: 1)

# we2_1 = WorkoutExercise.create(workout_id: 2, exercise_id: 2, user_id: 1)
# we2_2 = WorkoutExercise.create(workout_id: 2, exercise_id: 4, user_id: 1)
# we2_3 = WorkoutExercise.create(workout_id: 2, exercise_id: 5, user_id: 1)
